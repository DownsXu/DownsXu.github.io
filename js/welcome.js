...
function showWelcome() {
    ...
    let dist = getDistance(116.694374, 29.658812, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //经纬度替换成自己的位置
